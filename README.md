...
NewYorkcoinClient is a gem that makes it easy to work with newyorkcoin in ruby.

## Dependencies

The only requirement is a running newyorkcoin daemon ([newyorkcoind](https://github.com/NewYorkCoinNYC/newyorkcoin)). Make sure to check out the [doc section](https://github.com/NewYorkCoinNYC/newyorkcoin/tree/master/doc) and follow the instructions for your os.
NOTICE: by default newyorkcoind will only allow local connections.

## Installation

Add this line to your application's Gemfile:

    gem 'newyorkcoin_client'

Or install it yourself as:

    $ gem install newyorkcoin_client
...
```ruby
# config/initializers/newyorkcoin_client.rb
...
```ruby
client = NewYorkcoinClient.new(user: 'my_newyorkcoind_username', password: 'my_super_secure_password')
```
...
# check that newyorkcoind is running and that our credentials are correct
if client.valid?
...
<td> <b>Currently only available on testnet</b> Add a nrequired-to-sign multisignature address to the wallet. Each key is a newyorkcoin address or hex-encoded public key. If [account] is specified, assign address to [account]. </td>
<td> No
</td></tr>
<tr>
<td> backup_wallet </td>
...
<tr>
<td> dump_priv_key </td>
<td> [newyorkcoinaddress] </td>
<td> Reveals the private key corresponding to <newyorkcoinaddress< </td>
<td> Yes
</td></tr>
<tr>
...
<td> [account] </td>
<td> Returns the current newyorkcoin address for receiving payments to this account. </td>
<td> No
</td></tr>
<tr>
...
<td> get_generate </td>
<td> </td>
<td> Returns true or false whether newyorkcoind is currently generating hashes </td>
<td> No
</td></tr>
<tr>
...
<td> [account] </td>
<td> Returns a new newyorkcoin address for receiving payments.  If [account] is specified (recommended), it is added to the address book so payments received with the address will be credited to [account]. </td>
<td> No
</td></tr>
<tr>
...
<td> [newyorkcoinaddress] [minconf=1] </td>
<td> Returns the total amount received by <newyorkcoinaddress< in transactions with at least [minconf] confirmations. While some might consider this obvious, value reported by this only considers *receiving* transactions. It does not check payments that have been made *from* this address. In other words, this is not "getaddressbalance". Works only for addresses in the local wallet, external addresses will always show 0. </td>
<td> No
</td></tr>
<tr>
...
<td> [newyorkcoinprivkey] [label] </td>
...
<p>To get a list of accounts on the system, execute newyorkcoind listreceivedbyaddress 0 true
</p>
</td>
<td> No
</td></tr>
...
<tr>
<td> send_from </td>
<td> [fromaccount] [tonewyorkcoinaddress] [amount] [minconf=1] [comment] [comment-to] </td>
...
<tr>
<td> sign_message </td>
<td> [newyorkcoinaddress] [message] </td>
...
<td> stop </td>
<td> </td>
<td> Stop newyorkcoin server. </td>
<td> No
</td></tr>
<tr>
<td> validate_address </td>
<td> [newyorkcoinaddress] </td>
<td> Return information about [newyorkcoinaddress]. </td>
<td> No
</td></tr>
<tr>
<td> verify_message </td>
<td> [newyorkcoinaddress] [signature] [message] </td>
...
For local testing, make sure to replace the user/password in `spec/client_spec.rb` and `spec/newyorkcoin_client_spec.rb` with the credentials for your local newyorkcoind.
